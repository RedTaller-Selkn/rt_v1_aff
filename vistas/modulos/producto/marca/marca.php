...
<div class="container">
        ...
        <div class="row">
            <div class="col-2 offset-10">
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#modalMarca" id="botonCrear">
        ...
        <div class="table-responsive">
            <table id="dt_marca" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th>Nombre</th>
    ...
    <div class="modal fade" id="modalMarca" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" id="formulario" enctype="multipart/form-data" action="modelos/producto/marca/crear.php">
                    <div class="modal-content">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var dataTable = $('#dt_marca').DataTable({
                "processing": true,
                "ServerSide": true,
                "order": [],
                "ajax": {
                    url: "modelos/producto/marca/obtener_registros.php",
                    type: "POST"
                },
                "columnsDefs": [{
                    "targets": [0, 3, 4],
            ...
            $("#formulario").on('submit', function(event) {
                ...
                if (nombre != '') {
                    $.ajax({
                        url: "modelos/producto/marca/crear.php",
                        method: "POST",
            ...
            $(document).on('click', '.editar', function(){
                ...
                $.ajax({
                    url:"modelos/producto/marca/obtener_registro.php",
                    method: "POST",
                    data:{id:id},
                    dataType: "json",
                    success:function(data)
            ...
            $(document).on('click', '.borrar', function(){
                var id = $(this).attr("id");
                if(confirm("Esta seguro de eliminar la marca?"+id)){
                    $.ajax({
                    url:"modelos/producto/marca/borrar.php",
                    method: "POST",
                    data:{id:id},
                    success:function(data)
                        {
