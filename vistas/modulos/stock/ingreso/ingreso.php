...
<section class="content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-2 offset-10">
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#modalingreso" id="botonCrear">
        ...
        <div class="table-responsive">
            <table id="dt_ingreso" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th>Compra</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Realizar ingreso</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <form method="POST" id="formulario" enctype="multipart/form-data" action="modelos/movimiento/ingreso/crear.php">
                    <div class="modal-content">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#botonCrear").click(function() {
                $("#formulario")[0].reset();
                $(".modal-title").text("Realizar ingreso");
                $("#action").val("Crear");
                $("#operacion").val("Crear");
            });
            $.ajax({
            ...
            var dataTable = $('#dt_ingreso').DataTable({
                "processing": true,
                "ServerSide": true,
                "order": [],
                "ajax": {
                    url: "modelos/stock/ingreso/obtener_registros.php",
                    type: "POST"
                },
                "columnsDefs": [{
                    "targets": [0, 3, 4],
            ...
            $("#formulario").on('submit', function(event) {
                ...
                if (nombre != '') {
                    $.ajax({
                        url: "modelos/stock/ingreso/crear.php",
                        method: "POST",
            ...
            $(document).on('click', '.editar', function() {
                ...
                $.ajax({
                    url: "modelos/stock/ingreso/obtener_registro.php",
                    method: "POST",
                    data: {
                        id: id
                    },
            ...
            $(document).on('click', '.borrar', function() {
                var id = $(this).attr("id");
                if (confirm("Esta seguro de eliminar el ingreso?" + id)) {
                    $.ajax({
                        url: "modelos/stock/ingreso/borrar.php",
                        method: "POST",
                        data: {
                            id: id
                        },
